...
const GroupComponent2 = ({ className = "", propWidth, card, starIcon1 }) => {
  ...
  return (
    <div
      className={`h-[335px] w-[291px] rounded-3xs border-surface-light border-[2px] border-solid box-border flex flex-col items-end justify-start pt-[0.8px] px-0 pb-[5.7px] gap-[8.4px] z-[1] text-center text-xs text-surface-light font-poppins ${className}`}
