...
const Footer = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-end py-0 pl-[3px] pr-px box-border max-w-full ${className}`}
    >
      <footer className="flex-1 flex flex-col items-end justify-start gap-[70px] max-w-full text-left text-xl text-surface-light font-poppins mq450:gap-[17px] mq800:gap-[35px]">
        <div className="self-stretch flex flex-row items-start justify-end py-0 pl-[39px] pr-[29px] box-border max-w-full">
          <div className="flex-1 flex flex-row items-end justify-start gap-[40.5px] max-w-full mq800:gap-5 mq1350:flex-wrap">
            <div className="w-[367px] flex flex-col items-start justify-start pt-0 px-0 pb-[57px] box-border min-h-[210px] max-w-full text-justify text-sm">
              <div className="self-stretch flex flex-col items-start justify-start gap-[19px]">
                <div className="w-[220px] h-[65px] flex flex-row items-start justify-start py-0 px-px box-border">
                  <div className="self-stretch flex-1 flex flex-row items-center justify-start bg-[url('/public/as01-1@2x.png')] bg-cover bg-no-repeat bg-[top] z-[2]">
                    <img
                ...
                <div className="self-stretch relative leading-[23px] z-[2]">
                  ...
                  Answers tailored to your needs, curated by top 1%
                  professional’s across the Country.
                </div>
              </div>
            </div>
            ...
            <div className="w-[745px] flex flex-row items-start justify-start gap-[31px] max-w-full mq800:flex-wrap mq800:gap-[15px]">
              <div className="w-[297px] flex flex-col items-start justify-start gap-[25px] min-w-[297px] mq800:flex-1">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-1.5 text-base">
                  ...
                  <div className="w-[282px] flex flex-col items-start justify-start gap-[11px] text-xl">
                    ...
                    <div className="flex flex-row items-start justify-start gap-[18.1px]">
                      <img
              ...
              <div className="flex-1 flex flex-col items-start justify-start gap-[25px] min-w-[271px] max-w-full">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[17px] max-w-full text-base">
                  ...
                  <div className="w-[403px] flex flex-row items-start justify-start gap-2 max-w-full text-center mq450:flex-wrap">
                    <TextField
                    ...
                    />
                    <div className="w-[104px] rounded-21xl bg-gray1-400 border-surface-light border-[1px] border-solid box-border flex flex-row items-start justify-start z-[2]">
