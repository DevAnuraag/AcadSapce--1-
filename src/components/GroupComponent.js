...
const GroupComponent = ({ className = "", blog4jpg }) => {
  return (
    <div
      className={`rounded-3xs [background:linear-gradient(#fff,_#fff),_linear-gradient(rgba(31,_188,_203,_0.1),_rgba(31,_188,_203,_0.1)),_linear-gradient(180deg,_#020c0d,_rgba(31,_188,_203,_0))] border-surface-light border-[1px] border-solid box-border flex flex-col items-start justify-start pt-0 px-0 pb-[15px] gap-4 max-w-full shrink-0 z-[1] text-left text-sm text-black font-poppins ${className}`}
    >
      ...
      <div className="w-36 flex flex-row items-start justify-start py-0 px-[9px] box-border">
        <div className="flex-1 rounded-xl border-black border-[1px] border-solid flex flex-row items-start justify-start pt-1 px-[11px] pb-px gap-[7px] z-[1]">
