...
const BlogContent = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row  items-center justify-center pt-0 pl-0.5 pr-0 box-border max-w-full text-center text-21xl text-gray1-700 font-poppins mq1125:box-border  mq450:box-border ${className}`}
    >
      <div className="flex items-center justify-center h-[100vh]">
        
        <div className="flex-1 flex flex-col items-center justify-center gap-[55px] max-w-full mq800:gap-[27px]">
          
          <div className="self-stretch flex flex-row items-center justify-center py-0 pl-[75px] pr-[76px] box-border max-w-full mq800:pl-[37px] mq800:pr-[38px] mq800:box-border">
            <h1 className="m-0 flex-1 relative text-center text-inherit leading-[200%] font-bold font-inherit inline-block [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25),_0px_4px_4px_rgba(0,_0,_0,_0.25)] max-w-full z-[2] mq800:text-13xl mq800:leading-[64px] mq450:text-5xl mq450:leading-[48px]">
