    ...
    <div className="w-full relative flex flex-row items-start justify-start leading-[normal] tracking-[normal]">
      <main className="flex-1 bg-midnightblue-100 flex flex-col items-start justify-start pt-0 px-0 pb-[33.3px] box-border gap-[161.7px] max-w-full mq450:gap-10 mq800:gap-[81px] mq1350:pt-5 mq1350:pb-5 mq1350:box-border">
        ...
        <img
          ...
          alt=""
          src="/original-165ac86b13223f21f0ff259fde26d8f0.png"
        />

        <section className="self-stretch flex flex-row items-center bg-red-300 justify-center pt-0 h-[100vh] pl-0 box-border max-w-full text-center text-21xl text-gray1-700 font-poppins mq450:pb-[243px] mq450:box-border mq1125:pb-[374px] mq1125:box-border">
        ...
        <section x="self-stretch flex flex-col items-start justify-start gap-[110px] max-w-full text-center text-31xl text-surface-light font-poppins mq450:gap-[27px] mq800:gap-[55px]">
